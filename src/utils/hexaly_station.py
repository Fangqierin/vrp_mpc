...
# from load_data_from_chains_online import get_data as get_data_Hexlay

from src.policies.mpc.MPC_VRP.src.utils.load_data_hexlay import get_data_Hexlay


def pdptw_hexlay_solver(
    n,
    P,
    D,
    C,
...
def main(chain_id, num_vehicles, vehicle_capacity, delta, num_stations, station_nodes):
    ...
    # )
    n, P, D, C, tau, add_time_for_break, c, add_cost_for_break, a, b, s, ell, depot = get_data_Hexlay(
        CarNumber=num_vehicles,
        Capacity=vehicle_capacity,
        parking_nodes=station_nodes,
    )
    RESULTS_DIR = "./results"
